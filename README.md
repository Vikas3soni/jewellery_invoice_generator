...
Web application for invoice generator for jewellery shops,
Feature
- Customer Add
- Product Add
- Invoice creation
...
ssh -L 5433:localhost:5555 vikas@34.131.21.34 -— for postgres

ssh -L 5433:localhost:5432 vikas@34.131.95.73
